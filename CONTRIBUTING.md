...
Domain-specific KDNA packages belong in **separate repositories** under the `knowledge-dna` organization. See the [registry policy](./docs/registry-policy.md) for the inclusion criteria.
