...
// a symlinked or aliased directory still RUNS the readiness check (and can never
...
if (entryGuard === 'unresolved-entry') {
  console.error(
    'KDNA_SCOPED_RELEASE_READINESS_ENTRY_GUARD_FAILED: refusing to run under an unresolved entry path',
  );
  process.exit(2);
}
