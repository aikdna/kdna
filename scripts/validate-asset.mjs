#!/usr/bin/env node
/**
 * validate-asset.mjs — development entry point for the official asset validate route.
 *
 * Usage: node scripts/validate-asset.mjs <source-dir>
 *
 * This script is a thin shim that delegates to the official CLI
 * (`packages/kdna/bin/kdna.js validate`) so development and packaged entry
...
if (!sourceDir) {
  console.error('Usage: node scripts/validate-asset.mjs <source-dir>');
  process.exit(2);
}
