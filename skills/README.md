...
> **The actual SKILL.md files live in [kdna-skills](https://github.com/aikdna/kdna-skills).**
...
- `ensureLoaderSkill()` in `src/install.js` fetches from
  `https://raw.githubusercontent.com/aikdna/kdna-skills/main/<skill>/SKILL.md`
  by default.
