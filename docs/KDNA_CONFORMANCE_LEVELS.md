...
| **Evaluated KDNA** | Has eval cases with scoring reports | `evals/` directory + scoring artifacts |
| **Reference example KDNA** | Published as an official demonstration asset | Official toolchain publication |
...
4. **Trust is a consumer decision.** The `quality_badge` field provides evidence; the consumer decides what to trust.
