...
[![KDNA Spec](https://img.shields.io/badge/KDNA-v0.4-4c1)](https://github.com/aikdna/KDNA)
...
\`\`\`bash
kdna install github:aikdna/kdna-<domain-id>
\`\`\`
...
```json
{
  ...
  "name": "<Domain Name>",
  "version": "0.1.0",
  "repo": "https://github.com/aikdna/kdna-<domain-id>",
  "spec_version": "0.4",
  "status": "experimental",
  "access": "open",
  "language": ["en"],
