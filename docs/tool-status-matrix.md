...
|---|---|---|---|---|---|---|
| **kdna inspect** | Official v1 inspection | available in global CLI (@0.26.7) | yes | `kdna inspect <file.kdna>` | | |
| **kdna validate** | Official v1 validation | available in global CLI (@0.26.7) | yes | `kdna validate <file.kdna>` | | |
| **kdna plan-load** | Official LoadPlan check | available in global CLI (@0.26.7) | yes | `kdna plan-load <file.kdna>` | | |
| **kdna load** | Runtime loading | available in global CLI (@0.26.7) | yes | `kdna load <file.kdna> --profile=compact --as=prompt` | | |
| **kdna pack** | Official deterministic pack | available in global CLI (@0.26.7) | yes | `kdna pack <dev-source> <out.kdna>` | Creator/debug workflow, not public consumption | |
| **kdna unpack** | Official unpack | available in global CLI (@0.26.7) | yes | `kdna unpack <file.kdna> <out>` | Editing/debug view, not a separate public asset | |
