...
> **Audit note refresh 2026-06-27**: The original audit (2026-06-16) listed 10
> example paths as "intentionally kept". Between then and now, commit
> `3bdbb0f` (2026-06-23, "chore: remove legacy domain artifacts") deleted 6 of
> those: `communication`, `management`, `product_decision`, `sales`,
> `speaking_basic`, `writing_basic`. They no longer exist on disk and the
> "kept as-is" rationale above is no longer accurate for them. The remaining
> actually-still-present paths in this list (as of 2026-06-27):
>
> **Examples (5):**
