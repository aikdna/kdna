...
*KDNA (Knowledge DNA) is an open format for encoding domain cognition for AI agents. See [github.com/aikdna/KDNA](https://github.com/aikdna/KDNA) for the specification, reference implementations, and reproducible benchmarks.*
