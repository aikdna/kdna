...
- ✅ Reference assets: `kdna_authoring`, `agent_safety`, `prompt_diagnosis`, `code_review`, `writing`
...
- ✅ Reference consumption client — macOS
- ✅ Reference authoring client — macOS
